...
import DocumentsModal from "./DocumentsModal"; // ✅ Import your document modal
    ...
    <ModalWrapper>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-2xl font-bold text-gray-800">Edit User Profile</h3>
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  className="block w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none"
                  value={formData.role}
                  onChange={(e) =>
          ...
          <div className="flex items-center justify-between gap-3 pt-4 border-t border-gray-200">
            <button
              type="button"
              onClick={() => setDocsModalOpen(true)} // ✅ open document modal
              className="px-4 py-2 bg-gray-100 text-gray-800 rounded-lg text-sm font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
              Manage Documents
            </button>
